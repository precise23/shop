...
class Urls {
    public static $PRODUCT_CREATED = "index.php?controller=product&action=created";
    public static $PRODUCT_CREATE = "index.php?controller=product&action=create";
    public static $PRODUCT_DELETE = "index.php?controller=product&action=delete";
